  ...
  return (
    <div className="space-y-4">
      <form
        ref={formRef}
        onSubmit={onCreate}
        className="grid gap-3 rounded-xl border border-brand-100 bg-white p-4 md:grid-cols-4"
      >
        {/* Name */}
        ...
        <button
          type="submit"
          className="rounded-lg bg-brand-600 px-4 py-2 text-sm font-medium text-white md:col-span-4"
        >
          Add customer
        </button>
      </form>
